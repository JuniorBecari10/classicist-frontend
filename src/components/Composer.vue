...
<template>
    <section class="font-fredoka">
        <div class="bg-[url('./src/resources/Amadeus.jpg')] h-60 bg-[center_-40rem]">
            <div class="h-1/1 bg-gradient-to-t from-[#252525] to-transparent to-80%">
